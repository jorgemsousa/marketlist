      ...
      <ScrollView className="flex-1">
        {products.map((product) => (
          <View key={product.id} className="flex-row items-center mb-4">
            <Text className="ml-2 w-40">{product.name}</Text>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                handleUpdateProduct(product.id, "quantity", parseInt(text) || 0)
              }
            />
            <TextInput
              ...
              editable={!product.bought}
              onChangeText={(text) =>
                handleUpdateProduct(product.id, "price", parseFloat(text) || 0)
              }
            />
          </View>
        ))}
